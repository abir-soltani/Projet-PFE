...
import { Utilisateur } from '../components/model/utilisateur';
...
// Performance indicator chart
  ...
  constructor(calendar: NgbCalendar,private utilisateurService: UtilisateurService) {
  ...
  ngOnInit(): void {
    this.utilisateurService.listeUtilisateur().subscribe(u=>{
      console.log(u);
      this.utilisateurs=u;
    })
  }
